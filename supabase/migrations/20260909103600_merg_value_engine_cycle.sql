...
-- Converts existing MERG opportunity/intelligence signals into deduplicated
-- MONEY / KNOWLEDGE work items. External execution remains policy-gated.
...
select cron.schedule(
  'merg-value-engine-cycle',
  '8,38 * * * *',
  'select public.merg_value_engine_cycle();'
);
